...
gcapi::GlueCodeReturn_t MatrixAddV1F32Gaudi2::GetKernelName(
...
gcapi::GlueCodeReturn_t MatrixAddV1F32Gaudi2::GetGcDefinitions(
            ...
            gcapi::HabanaKernelInstantiation_t* instance)
{
    ...
    **************************************************************************************/
    ...
    instance->indexSpaceGeometry.sizes[1] = outputSizes[1];
    ...
    **************************************************************************************/
    ...
    instance->inputTensorAccessPattern[0].dim[1].start_a  = 1;
    instance->inputTensorAccessPattern[0].dim[1].end_a    = 1;
    instance->inputTensorAccessPattern[0].dim[1].start_b  = 0;
    instance->inputTensorAccessPattern[0].dim[1].end_b    = 0;
    ...
    instance->inputTensorAccessPattern[1].dim[1].start_a  = 1;
    instance->inputTensorAccessPattern[1].dim[1].end_a    = 1;
    instance->inputTensorAccessPattern[1].dim[1].start_b  = 0;
    instance->inputTensorAccessPattern[1].dim[1].end_b    = 0;
    ...
    instance->outputTensorAccessPattern[0].dim[1].start_a  = 1;
    instance->outputTensorAccessPattern[0].dim[1].end_a    = 1;
    instance->outputTensorAccessPattern[0].dim[1].start_b  = 0;
    instance->outputTensorAccessPattern[0].dim[1].end_b    = 0;
